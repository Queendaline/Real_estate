                ...
                <div class="row">
                    <div class="col-lg-8 col-md-6 col-sm-12">
                        ...
                        <form id="contactform" class="contact-form" name="contactform" method="post" novalidate>
                            ...
                            <div class="form-group">
                                <input type="text" required class="form-control input-custom input-full" name="middle_name" placeholder="Middle Name">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 bgc">
                        <div class="call-info">
                            <h3>Contact Details</h3>
                            <p class="mb-5">Please find our details below and contact us today!</p>
                            <ul>
                                <li>
                                    <div class="info">
